...
var (
	...
	useService = flags.Bool("use-service", false, `use Service ip instead of Pod's for mapping keep alive`)
...
func main() {
	...
	ipvsc := newIPVSController(kubeClient, namespace, *useUnicast, *configMapName, *vrid, *useService)
